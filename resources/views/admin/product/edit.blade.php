                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="short_description" id="short_description" cols="30" rows="10" class="summernote" placeholder="short_Description">{{$products->short_description}}</textarea>
                                            <p class="error"></p>
                                        </div>
                                    </div>   
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="shipping_return" id="shipping_return" cols="30" rows="10" class="summernote">{{$products->shipping_return}}</textarea>
                                            <p class="error"></p>
                                        </div>
                                    </div>   
