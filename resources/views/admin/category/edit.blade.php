                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="category_name" id="category_name" class="form-control" value="{{$category->category_name}}" placeholder="Category Name">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug" readonly class="form-control" value="{{$category->slug}}" placeholder="Category Slug">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-2">
                                @if (!empty($category->image))
                                    <div class="text-center mb-3">
                                        <img src="{{ asset('uploads/category/thumb/'.$category->image)}}" class="rounded-circle border" width="150" height="150" alt="category-img" >
                                    </div>
                                @endif
                            </div>
